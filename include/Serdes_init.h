 ...
 ******************************************************************************
 File Name     : Serdes_init.h
  Version       : v1.0
  Author        : 
  Created       : 2017-02-13
  Last Modified :
  Description   :  Serdes_init.c header file, example for Serdes configuration on DSP
...
******************************************************************************/
#ifndef _SERDES_INIT_H_
#define _SERDES_INIT_H_
