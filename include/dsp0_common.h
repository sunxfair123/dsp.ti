 ...
 ******************************************************************************
  File Name     : dsp0_common.h
  Version       : Initial Draft
  Author        : Zhan
  Created       : 2012/10/30
  Last Modified :
  Description   : dsp0_common.c header file, KeyStone common miscellaneous functions and definitions
  Function List :
  History       :
  History		:
   1.Date		  : 2017-02-13
...
******************************************************************************/
#ifndef __DSP0_COMMON_H_
#define __DSP0_COMMON_H_
...
/*add by sxf 20160108 */
/* for 319 project debug  提供的最终版本中去掉*/
/*----------------------compile  macro----------------*/
#define CORE0_SOURCE 1
//#define CORE1_SOURCE
//#define CORE2_SOURCE
//#define CORE3_SOURCE
//#define CORE4_SOURCE
...
*/
extern void Core_PLL_init (float ref_clock_MHz,
 ...
 *****************************************************************************/
extern int PLL_init (PLL_ControlRegs * PLL_Regs, unsigned int inputDivisor, 
...
/*****************************************************************************
 ...
 Input        : float ref_clock_MHz
                ...
                unsigned int divisor: 1~64
*****************************************************************************/
extern void DDR_PLL_init (float ref_clock_MHz,
	unsigned int multiplier, unsigned int divisor);
...
/*===============================PSC===================================*/
extern Int32 debug_enable_PSC_module (Uint32 pwrDmnNum, Uint32 moduleNum);
extern Int32 debug_disable_PSC_module (Uint32 pwrDmnNum, Uint32 moduleNum);
extern Int32 debug_disable_PSC_Power_Domain (Uint32 pwrDmnNum);
...
/*memory transfer parameter configuration,used for CSL_TpccRegs*/
typedef struct
{
    Uint32 A_B_CNT; 	
    Uint32 SRC_DST_BIDX; 
...
extern void EDMA_copy_Type1(unsigned int uiSrcAddr, unsigned int uiDstAddr, 
...
extern void MPAX_seg_setup(MPAX_Regs * MPAX_regs, Uint32 BADDR, 
...
extern void XMC_MPAX_setup(MPAX_Config MPAX_cfg[], 
...
/* delete for DDR memory protection测试*/
...
extern void MSMC_MP_interrupt_en(Uint32 PRIVID_MASK);
...
extern void MPU_interrupts_enable();
...
/*****************************************************************************
 Prototype    : KeyStone_CIC_event_map
