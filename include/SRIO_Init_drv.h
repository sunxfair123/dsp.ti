...
#ifndef _SRIO_INIT_DRV_H_
#define _SRIO_INIT_DRV_H_
...
extern void SRIO_GlobalEnable(void);

/*Enable SRIO blocks*/
extern void SRIO_enable_blocks(
	SRIO_Block_Enable * blockEn);

/*Disable all SRIO blocks*/
extern void SRIO_disable_all_blocks();

/*soft shutdown and reset SRIO*/
extern void SRIO_soft_reset();

/*configure SRIO 1x 2x or 4x path mode*/
extern void SRIO_set_1x2x4x_Path(
	SRIO_1x2x4x_Path_Control srio_1x2x4x_path_control);

/*configure SRIO device ID*/
extern void SRIO_set_device_ID(
	SRIO_Device_ID_Routing_Config * device_id_routing_config,
...
/* interrupt map */
extern void SRIO_Interrupt_init(SRIO_Interrupt_Cfg * interrupt_cfg);

extern void KeyStone_SRIO_little_endian_swap(
	SRIO_Little_Endian_Swap_Mode leSwapMode);


extern void SRIO_drv_Init(SRIO_Config * srio_cfg);
